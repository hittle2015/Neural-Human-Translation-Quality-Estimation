...
class Trainer(BaseTrainer):
    ...
    def __init__(self, model, criterion, metric_ftns, optimizer, config, data_loader,
                 valid_data_loader=None, add_graph=True,test_data_loader=None, lr_scheduler=None, len_epoch=None):
        ...
        with torch.no_grad():
            for batch_idx, data in enumerate(self.valid_data_loader):
                ...
                if self.add_graph:
                    ...
                    self.writer.writer.add_graph(input_model,[input_ids,attention_masks,text_lengths])
